...
function MakeTeam({teamLeaderInfo, teamInfo, onComboboxSelected, onInputChanged}: Props){
            ...
            <div css={style}>
                        ...
                        <div className='val3'>
                            <span>{'“'}</span>
                                <div className='purp-box'>
                                    ...
                                    <div className='word-count'>{teamInfo.wordCount}/50자</div>
                                </div>
                            <span>{'”'}</span>
                        </div>
                    </div>
                ...
                <div className='foot'>
                    ...
                    <div className='btn-box'>
                        <div className='btn-done'>이렇게 팀 만들기</div>
                        <div className='btn-quit'>오늘은 안 만들게요</div>
                    </div>
                </div>
            </div>
        : null
